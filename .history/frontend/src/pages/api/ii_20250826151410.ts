...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Build the authorize URL using the public Internet Identity endpoint format requested.
  // Keep the canister/app context via the canister query param and include origin/redirect when provided.
