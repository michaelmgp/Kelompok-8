...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Build the authorize URL using the public Internet Identity endpoint format requested by the user.
  // This ensures the popup opens the standard II flow and shows the correct "continue to <origin>" message.
  const finalUrl = `https://identity.ic0.app/#authorize?canisterId=${canister}${originParam}${redirectParam}`;
