                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <Button className="w-full" variant="outline" data-testid="button-ii-login-local" onClick={async () => {
                          try {
                            // Force the frontend origin for II to localhost:6000 unless overridden
                            // via NEXT_PUBLIC_FRONTEND_ORIGIN. This ensures II shows the correct
                            // "Continue to <origin>" text even if dev server/proxy differs.
                            const origin = process.env.NEXT_PUBLIC_FRONTEND_ORIGIN || 'http://localhost:6000';
