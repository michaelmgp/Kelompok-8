...
import { idlFactory } from './job_contract.did.js';
export { idlFactory } from './job_contract.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_JOB_CONTRACT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./job_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the job_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./job_contract.did.js")._SERVICE>}
 */
export const job_contract = createActor(canisterId);
