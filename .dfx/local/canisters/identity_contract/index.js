...
import { idlFactory } from './identity_contract.did.js';
export { idlFactory } from './identity_contract.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IDENTITY_CONTRACT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./identity_contract.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the identity_contract canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./identity_contract.did.js")._SERVICE>}
 */
export const identity_contract = createActor(canisterId);
